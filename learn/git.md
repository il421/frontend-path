...
Если есть большая фича с разнобойными комитами и хочется смержить ее в мастер структурированно. Алгоритм: пройтись по комитам, слить по логике и уже потом заливать в мастер. Пример: http://stackoverflow.com/questions/27070921/git-ive-a-feature-branch-with-80-commits-how-can-i-safely-merge-it-into-deve


## Отличия `reset`, `checkout` и `revert`
