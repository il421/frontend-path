...
Прежде всего нужно уметь хорошо верстать, знать спецификации HTML и CSS.

Вместе с этим нужно понимать, что верстка — это далеко не все, что нужно для создания современного интерфейса. Нужно стремиться получить нужные знания в клиентском программировании и смежных областях.

Предложенный набор материалов рассчитан на освоение в течение 5 месяцев. Если у вас уже есть опыт (верстка, программирование, веб-разработка), то времени уйдет значительно меньше.
