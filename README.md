...
* Основы PHP: уметь пользоваться языком на уровне шаблонизатора и работать с вствроенный локальным сервером.
* Работа с проектом локально: раскатать, работа с базой, сервером, версиями PHP и MySQL.
* Основы виртуализации: Vagrant, Ansible, Docker.
...
* Мадженто — работа в даминке (User Guide).
* Мадженто — работа с темами (Design Guide).
* Фотошоп форматы и резка макета.
* Шрифты: грамотное подключение, работа с иконочнымм шрифтами.
* SVG: работа со спрайтами, оптимизация.

# Что учить джуниору
* Magento Frontend Developer.
* Продвинутая работа с Node, Gulp, Webpack для решения задач.
